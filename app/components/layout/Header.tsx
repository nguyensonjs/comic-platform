  ...
  return (
    <header
      className={`fixed top-0 z-50 w-full transition-all duration-500 ${
        scrolled
          ? 'border-b border-slate-800 bg-slate-950/90 shadow-[0_8px_32px_rgba(0,0,0,0.4)] backdrop-blur-xl'
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <Link href="/" className="group flex shrink-0 items-center gap-3">
            <div className="relative flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-blue-500 to-cyan-400 shadow-lg shadow-blue-500/20 transition-all duration-300 group-hover:scale-105 group-hover:shadow-blue-500/40">
              <Sparkles className="h-5 w-5 text-white" strokeWidth={2} />
              {/* glow ring on hover */}
              <div className="absolute inset-0 rounded-xl ring-0 ring-blue-400/0 transition-all duration-300 group-hover:ring-2 group-hover:ring-blue-400/40" />
            </div>
            <div className="flex flex-col leading-none">
              <span className="bg-gradient-to-r from-white to-slate-300 bg-clip-text text-[17px] font-black tracking-wide text-transparent">
                COSMIC
              </span>
          ...
          >
            ...
            <input
              ...
              className="w-full rounded-full border border-slate-700/60 bg-slate-900/70 py-2.5 pr-4 pl-11 text-sm text-slate-100 placeholder-slate-500 backdrop-blur-sm transition-all duration-300 focus:border-blue-500/50 focus:bg-slate-900 focus:ring-2 focus:ring-blue-500/20 focus:outline-none"
            />
          </form>
          ...
          <div className="flex shrink-0 items-center gap-1">
            ...
            <div className="hidden items-center gap-1 md:flex">
              ...
              <Link
                href="/login"
                className="group flex items-center gap-2 rounded-full border border-slate-700 bg-slate-800/70 px-4 py-2 text-sm font-semibold text-slate-200 backdrop-blur-sm transition-all duration-300 hover:border-blue-500/50 hover:bg-blue-600 hover:text-white hover:shadow-[0_0_20px_rgba(59,130,246,0.35)]"
              >
        ...
        <div
          className={`overflow-hidden transition-all duration-300 ease-in-out md:hidden ${
            isMenuOpen
              ? 'max-h-96 border-t border-slate-800 pb-6 opacity-100'
              : 'max-h-0 opacity-0'
          }`}
        >
          <div className="mt-4 space-y-3">
            ...
            <form onSubmit={handleSearch} className="relative">
              ...
              <input
                ...
                className="w-full rounded-2xl border border-slate-700 bg-slate-900/70 py-3 pr-4 pl-11 text-sm text-white placeholder-slate-500 focus:border-blue-500/50 focus:ring-2 focus:ring-blue-500/20 focus:outline-none"
              />
            </form>
