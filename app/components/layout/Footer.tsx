      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4 xl:gap-16">
          ...
          <div className="md:col-span-2 lg:col-span-1">
            <Link href="/" className="group mb-6 inline-flex items-center gap-3">
              <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-blue-500 to-cyan-400 shadow-lg shadow-blue-500/20 transition-all duration-300 group-hover:scale-105 group-hover:shadow-blue-500/40">
            ...
            <div className="flex gap-3">
              {socials.map(({ Icon, href, label, hoverColor }) => (
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className={`group flex h-10 w-10 items-center justify-center rounded-xl border border-slate-800 bg-slate-900 text-slate-500 transition-all duration-300 hover:-translate-y-0.5 ${hoverColor}`}
                >
          ...
          {/* ── Explore column ── */}
          <div>
            <h6 className="mb-6 text-xs font-bold tracking-widest text-slate-200 uppercase">
              Khám phá
            </h6>
          ...
          <div>
            ...
            <form className="relative mb-8">
              <input
                ...
                className="w-full rounded-xl border border-slate-700 bg-slate-900 py-3 pr-12 pl-4 text-sm text-white placeholder-slate-500 transition-all focus:border-blue-500/50 focus:ring-2 focus:ring-blue-500/20 focus:outline-none"
              />
              <button
                type="submit"
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-6 border-t border-slate-800/80 pt-8 md:flex-row">
          <div className="flex flex-col items-center gap-1 text-xs text-slate-500 md:items-start">
            <p>
              © 2024{' '}
              <span className="font-semibold text-slate-400">Cosmic Cultivation</span>. All rights reserved.
            </p>
