        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-6 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link href="/danh-sach" className="flex items-center gap-1.5 rounded-xl border border-slate-200 dark:border-slate-700/60 bg-slate-100 dark:bg-slate-900/50 px-4 py-2 text-sm font-semibold text-slate-600 dark:text-slate-400 transition-all hover:border-blue-500 hover:text-blue-600 dark:hover:text-slate-200">
      ...
      <section className="border-t border-slate-100 dark:border-slate-900 py-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-8 text-center">
            <h2 className="mb-2 text-2xl font-black text-slate-900 dark:text-white md:text-3xl">Tại sao chọn chúng tôi?</h2>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            {features.map(({ Icon, title, desc, color, bg, border }) => (
              <div key={title}
                className={`group rounded-2xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900/50 p-7 transition-all duration-300 hover:-translate-y-1 hover:bg-slate-50 dark:hover:bg-slate-900 hover:shadow-xl ${border}`}>
      ...
      <section className="py-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-7 text-center">
            <h2 className="mb-1.5 text-2xl font-black text-slate-900 dark:text-white md:text-3xl">Thể loại phổ biến</h2>
          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-6">
            {categories.map(({ Icon, name, color, bg, href }) => (
              <Link key={name} href={href}
                className="group flex flex-col items-center gap-4 rounded-2xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900/50 p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-slate-200 dark:hover:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-900 hover:shadow-xl">
                ...
                <span className="text-sm font-bold text-slate-700 dark:text-slate-200 transition-colors group-hover:text-blue-600 dark:group-hover:text-white">{name}</span>
              </Link>
            ))}
          </div>
        </div>
