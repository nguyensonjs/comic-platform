  ...
  return (
    <div className="min-h-screen bg-slate-950 pt-24 pb-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10">
          <h1 className="text-3xl font-black text-white md:text-4xl">Tất cả thể loại</h1>
          ...
          {genres.map((genre, i) => {
            ...
            return (
              <Link
                ...
                className={`group flex items-center gap-3 rounded-xl border border-slate-800/60 bg-slate-900/40 px-4 py-3 text-sm font-semibold text-slate-300 transition-all duration-200 hover:-translate-y-0.5 hover:border-slate-700 hover:bg-slate-900 hover:text-white hover:shadow-lg ${color.border}`}
              >
